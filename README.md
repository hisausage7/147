    ...
    <div id="container">
      <div id="welcome">
        ...
        <input
          type="number"
          id="questionLimit"
          placeholder="輸入題數,至多105題 / Enter number of questions"
          style="
            width: 100%;
            padding: 8px;
            margin-bottom: 10px;
      ...
      <div id="results" class="hidden">
        ...
        <div id="resultButtons" style="text-align: center; margin-bottom: 20px">
          ...
          <button id="restartBtn" class="btn" style="background: #28a745">
            重新開始 / Restart
          </button>
        </div>
      ...
      <script>
        document.addEventListener("DOMContentLoaded", function () {
          const questions = [
            ...
            {
              question:
                "The material letter code for 2017 aluminum alloy rivet is",
            ...
            {
              question:
                "Which one is not the advantage of anti-friction bearing?",
              options: [
                "A. Low friction",
            ...
            {
              question:
                "Which statement relating to electrical wiring is true?",
              options: [
